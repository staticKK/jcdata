...
public class BaiduscopeUtil {
     ...
     * @return
     */
    public static boolean isInPolygon(String lng,String lat){
        String partitionLocation = BaiduBorder.BORDER;
    ...
    public static void main(String[] args) {
        System.out.println(isInPolygon("113.8742829199028","22.565890725541235"));
    }
